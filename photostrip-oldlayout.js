        ...
        dataPromise1.then(function (data1) {
          ...
          data1.forEach(function (d, i) {
            ...
            if (imageUrls.length > 1) {
              ...
              let carouselItems = carouselInner
                ...
                let firstcol1 = titlerow.append("div").attr("class", "info-col");
                let pallo = firstcol1.append("div").attr("class", "title-col").html("<div class='circle-container'><svg><circle cx='50%' cy='50%' r='48%'></circle></svg></div>");
                let name = firstcol1.append("p").attr("class", "title-col")
                let secondcol1 = titlerow.append("div").attr("class", "info-col");
          ...
          .on("error", function (event) {
            ...
            let photodetails = carouselItems.append("div").attr("class", "photo-details row");
            let descriptioncol = photodetails.append("div").attr("class", "info-col description-col");
            let peoplecol = photodetails.append("div").attr("class", "info-col people-col");
            ...
            let placecol = photodetails.append("div").attr("class", "info-col place-col");
              ...
              secondcol1.html(() => (matchingRow ? matchingRow.Title : "N/A"));
              descriptioncol.html(() => (matchingRow ? matchingRow.Description : "N/A"));
              peoplecol.html(() => {
                const peopleInfo = matchingRow && matchingRow.metaDepictedPeople ? "People: " + matchingRow.metaDepictedPeople : "";
                return peopleInfo || "People: none";
              });
